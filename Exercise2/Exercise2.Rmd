...
ReLU introduces non-linearity but it does so using linear segments. The Keras library functions have features such as X and X, which in many cases contribute to improved results. 
