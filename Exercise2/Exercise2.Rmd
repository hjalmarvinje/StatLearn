...
ReLU introduces non-linearity in a manner similar to step functions, but it does so using linear segments instead of constant segments.In addition, ReLU uses only one step. 
